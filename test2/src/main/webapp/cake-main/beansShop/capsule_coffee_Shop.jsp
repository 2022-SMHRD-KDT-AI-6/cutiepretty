...
<body>
						...
						<div class="header__top__inner">
							...
							<div class="header__top__right">
								<div class="header__top__right__links">
									 <a
										href="#"><img src="/test/cake-main/img/icon/heart.png"
										alt=""></a>
								</div>
			...
			<div class="row">
				...
				<div class="col-lg-6 col-md-6 col-sm-6">
					<div class="breadcrumb__links">
						<a href="./index.html">홈</a> <span>캡슐</span>
					</div>
				</div>
			</div>
		</div>
						...
						<div class="shop__option__search">
							<form>
								<select name="category" id="cBox">
									...
									<option value="캐러멜">캐러멜</option>
									<option value="카페라떼">카페라떼</option>
									<option value="디카페인">디카페인</option>
								</select> <input type="text" placeholder="Search" id="searchEnter">
	...
	<div class="cd-signin-modal js-signin-modal">
		...
		<div class="cd-signin-modal__container">
			...
			<script src="/test/cake-main/js/capsule.list.js"></script>
			<!-- cd-signin-modal -->
