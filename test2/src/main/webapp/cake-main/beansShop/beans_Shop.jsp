...
<!-- Css Styles -->
<link rel="stylesheet" href="/test/cake-main/css/bootstrap.min.css"
	type="text/css">
<link rel="stylesheet" href="/test/cake-main/css/flaticon.css"
	type="text/css">
<link rel="stylesheet" href="/test/cake-main/css/barfiller.css"
	type="text/css">
<link rel="stylesheet" href="/test/cake-main/css/magnific-popup.css"
	type="text/css">
<link rel="stylesheet" href="/test/cake-main/css/font-awesome.min.css"
	type="text/css">
<link rel="stylesheet" href="/test/cake-main/css/elegant-icons.css"
	type="text/css">
<link rel="stylesheet" href="/test/cake-main/css/nice-select.css"
	type="text/css">
<link rel="stylesheet" href="/test/cake-main/css/owl.carousel.min.css"
	type="text/css">
<link rel="stylesheet" href="/test/cake-main/css/slicknav.min.css"
	type="text/css">
<link rel="stylesheet" href="/test/cake-main/css/style.css"
	type="text/css">
</head>
...
<body>
						...
						<div class="header__top__inner">
							...
							<div class="header__logo">
								<a href="../index.jsp"><img
									src="/test/cake-main/img/logo.png" alt=""></a>
							</div>
							<div class="header__top__right">
								<div class="header__top__right__links">
									 <a	href="#"><img src="/test/cake-main/img/icon/heart.png"
										alt=""></a>
								</div>
				...
				<div class="col-lg-12">
					<nav class="header__menu mobile-menu">
						<ul>
							...
							<li><a href="./beans_Shop.jsp">커피</a>
								<ul class="dropdown">
									<li><a href="./beans_Shop.jsp">원두</a></li>
									<li><a href="./ground_coffee_beans_Shop.jsp">분쇄 원두</a></li>
									<li><a href="./dripbag_coffee_Shop.jsp">드립백</a></li>
									<li><a href="./capsule_coffee_Shop.jsp">캡슐</a></li>
									<li><a href="./etc_coffee_Shop.jsp">기타재료</a></li>
								</ul></li>
							<li><a href="../machineShop/manual_coffee_machine_Shop.jsp">커피
									머신</a>
								<ul class="dropdown">
									<li><a
										href="../machineShop/manual_coffee_machine_Shop.jsp">수동</a></li>
									<li><a
			...
			<div class="row">
				...
				<div class="col-lg-6 col-md-6 col-sm-6">
					<div class="breadcrumb__links">
						<a href="../index.jsp">홈</a> <span>원두</span>
					</div>
				</div>
			</div>
		</div>
	...
	<section class="shop spad">
		<div class="container">
					...
					<div class="col-lg-7 col-md-7">
						<div class="shop__option__search">
							<form>
								...
								</select> <input type="text" placeholder="검색" id="searchEnter"> <input
			...
			<div class="row" id="beansList"></div>
			<div class="shop__last__option">
				<div class="row">
					<div class="col-lg-6 col-md-6 col-sm-6">
						<div class="shop__pagination">
							<a href="#">1</a> <a href="#"><span
	...
	<footer class="footer set-bg"
		data-setbg="/test/cake-main/img/footer-bg.jpg">
		<div class="copyright">
			<div class="container">
				<div class="row">
					<div class="col-lg-7">
	...
	<script src="/test/cake-main/js/beans.list.js"></script>
	<!-- cd-signin-modal -->
