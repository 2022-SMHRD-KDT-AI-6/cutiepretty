                        ...
                        <div class="shop__option__search">
                            <form>
                                <select name="category" id="cBox">
                                    ...
                                    <option value="커피분쇄기">커피분쇄기</option>
                                    <option value="커피추출기">커피추출기</option>
                                    <option value="모카포트">모카포트</option>
                                    <option value="스팀피쳐">스팀피쳐</option>
                                    <option value="여과지">여과지</option>
                                    <option value="콜드브루메이커">콜드브루메이커</option>
                                </select>
...
<script src="/test/cake-main/js/osMachine.list.js"></script>
	<!-- cd-signin-modal -->
