...
<link rel="stylesheet" href="css/instargram2.css" type="text/css">
</head>
				...
				<div class="col-lg-12">
					<nav class="header__menu mobile-menu">
						<ul>
							...
							<li><a href="./shop.html">커피</a>
								<ul class="dropdown">
									<li><a href="./beans_Shop.jsp">원두</a></li>
									<li><a href="./ground_coffee_beans_Shop.jsp">분쇄 원두</a></li>
									<li><a href="./shop.html">드립백</a></li>
									<li><a href="./shop.html">캡슐</a></li>
									<li><a href="./shop.html">기타재료</a></li>
								</ul></li>
							<li><a href="#">커피 머신</a>
								<ul class="dropdown">
									<li><a href="./shop.html">수동</a></li>
									<li><a href="./shop.html">반자동</a></li>
									<li><a href="./shop.html">전자동</a></li>
									<li><a href="./shop.html">기타용품</a></li>
								</ul></li>
							<li><a href="#">인테리어</a>
								<ul class="dropdown">
									<li><a href="./shop.html">가구</a></li>
									<li><a href="./shop.html">소품</a></li>
								</ul></li>
							<li><a href="#">커뮤니티</a>
								<ul class="dropdown">
							...
							<li class="active"><a href="./blog.html">상품 제안 및 문의</a></li>
						</ul>
					</nav>
				</div>
			</div>
					...
					<div class="blog__item">
									...
									<div class="post">
										<div class="info">
											<div class="user">
												...
												<p class="username">김이강김</p>
											</div>
											<!-- <img src="img/option.PNG" class="options" alt=""> -->
										</div>
										<img src="img/cake-piece.png" class="post-image" alt="">
										<div class="post-content">
											<div class="reaction-wrapper">
												<img src="img/like.PNG" class="icon" alt=""> <img
													src="img/comment.PNG" class="icon" alt="">
                        ...
                        <img src="img/save.PNG" class="save icon" alt=""> -->
										...
										<div class="comment-wrapper">
											<img src="img/cake-piece.PNG" class="icon" alt=""> <input
